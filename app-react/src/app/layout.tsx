...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col bg-radial from-slate-300 to-[#eef0fa] font-sans text-gray-900 print:m-0 print:p-0 print:w-full print:max-w-none print:bg-white mb-36">
