...
export function LocalVotacaoPicker({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <div className="flex max-h-[600px] flex-col gap-1 overflow-y-auto rounded-md border bg-gray-50 p-2 pr-2">
        {filtered.length === 0 ? (
          ...
          filtered.map((l) => {
            ...
            return (
              <Link
                ...
                className={`block rounded-md p-2 text-sm transition-colors ${isActive ? 'bg-[#0b2545] text-white' : 'text-gray-700 hover:bg-gray-200'}`}
